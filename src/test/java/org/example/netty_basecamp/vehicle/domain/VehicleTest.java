...
class VehicleTest {
    ...
    class Create {
        ...
        void AVAILABLE_상태로_생성() {
            ...
            assertThat(vehicle.getHomeLocation()).isEqualTo(HOME);
    ...
    class StartTrip {
        ...
        void ON_TRIP에서_재시작_예외() {
            Vehicle onTrip = createAvailableVehicle().startTrip(2000L);
        ...
        void OFFLINE에서_시작_예외() {
            Vehicle offline = createAvailableVehicle().goOffline(2000L);
        ...
        void 불변_필드_유지() {
            Vehicle vehicle = createVehicleWithId(1L);

            Vehicle onTrip = vehicle.startTrip(2000L);

            assertThat(onTrip.getPlateNumber()).isEqualTo("12가3456");
            assertThat(onTrip.getType()).isEqualTo(VehicleTypeEnum.SEDAN);
            assertThat(onTrip.getHomeLocation()).isEqualTo(HOME);
        }
    }
    ...
    private Vehicle createVehicleWithId(Long id) {
