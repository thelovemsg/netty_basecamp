package org.example.netty_basecamp.coupon.application;

import org.example.netty_basecamp.domain.common.vo.Inventory;
import org.example.netty_basecamp.domain.common.vo.Money;
import org.example.netty_basecamp.domain.coupon.application.CouponIssueApplicationService;
...
import org.example.netty_basecamp.domain.fare.domain.FareStatusEnum;
import org.example.netty_basecamp.domain.fare.domain.FareTypeEnum;
import org.example.netty_basecamp.domain.fare.domain.calculation.FareCalculationPipeline;
import org.example.netty_basecamp.domain.fare.domain.calculation.FarePolicyStrategyRegistry;
import org.example.netty_basecamp.domain.fare.domain.calculation.strategies.FixedAmountDiscountStrategy;
import org.example.netty_basecamp.domain.fare.domain.calculation.strategies.LongStayDiscountStrategy;
import org.example.netty_basecamp.domain.fare.domain.calculation.strategies.WeekendSurchargeStrategy;
...
import org.example.netty_basecamp.fake.repository.FakeCouponRepository;
